...
Route::post('checkinput',[indexController::class,'checkinput'])->name('check.route');
...
Route::get('deleteengsop/{id}',[SOP_controller::class,'deletesop']);
...
Route::get('uploadsop',[SOP_controller::class,'uploadsop'])->name('engine.uploadsop');
...
Route::post('statistics',[statisticsCotroller::class,'statistics'])->name('statistics');
