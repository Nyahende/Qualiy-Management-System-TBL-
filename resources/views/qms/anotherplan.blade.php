...
<body>
    <div class="anotherplansdiv">
    <h1 class="anotherplansheader">WEEKLY PLANS & SUPPORT</h1>
    <div class="anotherplansul">
    <ul>
        <li><a href="plannedactions"> PLANNED ACTIONS</a></li> <hr>
        <li><a href="objectives"> QUALITY OBJECTIVES</a></li> <hr>
        <li><a href="changes"> PLANNED CHANGES</a></li> <hr>
        <li><a href="competence"> RESOURCES & COMPETENCE</a></li> <hr>
