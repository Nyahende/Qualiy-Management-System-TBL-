...
<div id="engineershome" >
   ...
   <form action="{{route('transport.addworker')}}" class="raw-material-input-form" method="POST">
       @csrf
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Extra}}</td>
           <td><a href="{{'edittransportworker/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletetrans/'.$item->id}}">delete</a></td>
           </tr> 
           @endforeach
        </table>
        </div>
   ...
   <form action="{{route('store.addtransmachinesmachines')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Status}}</td>
           <td><a href="{{'edittransportmachine/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletetransmachines/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <form action="{{route('trans.transsafety')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Size}}</td>
           <td>{{$item->Quantity}}</td>
           <td><a href="{{'editsafetytransport/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletetranssafety/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="worker-form-div">
   <form action="{{route('addtranstrain')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
       ...
       <tr>
           ...
           <td>{{$item->Ends}}</td>
           <td>{{$item->Approval}}</td>
           <td><a href="{{'edittraintrans/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletetranstrain/'.$item->id}}">Delete</a></td>
           </tr> 
           @endforeach
        </table>
    </div>
   ...
   <div class="tool-form-div">
   <form action="{{route('trans.addtransdefects')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <span class="raw-material-input-span">
       <label for="approve" class="input-raw-label" class="raw-input"> Approve:</label>
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Approve}}</td>
           <td><a href="{{'transporteditdefects/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletetransportdefects/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="competence-qms-team">
       <h1>TRANSPORT DEPARTMENT TEAM</h1>
       <div class="theqmul">
           <ul>
