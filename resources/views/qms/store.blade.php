...
<head>
    ...
    <title>QMS | STORE/WAREHOUSE</title>
</head>
...
<div id="engineershome" >
   ...
   <form action="{{route('store.addworker')}}" class="raw-material-input-form" method="POST">
       @csrf
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Extra}}</td>
           <td><a href="{{'editstoreworker/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletestore/'.$item->id}}">delete</a></td>
           </tr> 
           @endforeach
        </table>
        </div>
   ...
   <form action="{{route('store.ddstoremachinesmachines')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Status}}</td>
           <td><a href="{{'editstoremachine/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletestoremachine/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <form action="{{route('store.storesafety')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Size}}</td>
           <td>{{$item->Quantity}}</td>
           <td><a href="{{'editstoresafety/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletestoresafety/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="worker-form-div">
   <form action="{{route('storeaddtrain')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
       ...
       <tr>
           ...
           <td>{{$item->Ends}}</td>
           <td>{{$item->Approval}}</td>
           <td><a href="{{'edittrainstore/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletestoretrain/'.$item->id}}">Delete</a></td>
           </tr> 
           @endforeach
   </table>
       </div>
   ...
   <div class="tool-form-div">
   <form action="{{route('store.addstoredefects')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Approve}}</td>
           <td><a href="{{'editstoredefects/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletestoredefects/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="competence-qms-team">
       <h1>STORE/WHAREHOUSE DEPARTMENT TEAM</h1>
       <div class="theqmul">
           <ul>
