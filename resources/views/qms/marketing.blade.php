...
<head>
    ...
    <title>QMS | MARKETING & PROCUREMENT</title>
</head>
...
<div id="engineershome" >
   ...
   <form action="{{route('marketing.addworker')}}" class="raw-material-input-form" method="POST">
       @csrf
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Extra}}</td>
           <td><a href="{{'editmarketingworker/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletemarketing/'.$item->id}}">delete</a></td>
           </tr> 
           @endforeach
        </table>
        </div>
   ...
   <form action="{{route('market.addmarketingmachines')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Status}}</td>
           <td><a href="{{'editmachinemarketing/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletemarketingmachines/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <form action="{{route('markting.addmarketingsafety')}}" method="POST" class="raw-material-input-form">
      @csrf
   <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Size}}</td>
           <td>{{$item->Quantity}}</td>
           <td><a href="{{'editsafetymarketing/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletemarketingsafety/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="worker-form-div">
   <form action="{{route('marketing.addtrain')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
       ...
       <tr>
           ...
           <td>{{$item->Ends}}</td>
           <td>{{$item->Approval}}</td>
           <td><a href="{{'edittrainmarketing/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletemarketingtrain/'.$item->id}}">Delete</a></td>
           </tr> 
           @endforeach
   </table>
       </div>
   ...
   <div class="tool-form-div">
   <form action="{{route('marketing.addmarketingdefects')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Approve}}</td>
           <td><a href="{{'editmarketingdefects/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deletemarketingdefects/'.$item->id}}">delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="competence-qms-team">
       <h1>MARKETING/PROCUREMENT DEPARTMENT TEAM</h1>
       <div class="theqmul">
           <ul>
