...
<body>
    ...
    <h1 class="chatword">CHATS</h1>
        ...
        <h1 class="loginfor">MARKETING DEPARTMENT</h1>
   ...
   <h1 class="raw-material-product-name">MARKETING DEPARTMENT WORKERS</h1>
   <div class="edit-worker-form-div">
   <form action="{{route('updatemarketingworker')}}" class="raw-material-input-form" method="POST">
         @csrf
