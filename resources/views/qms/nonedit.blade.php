...
<body>
  ...
  <div class="rawmaterialstab">
   ...
   <form action="{{route('updatenon')}}" method="POST" class="raw-material-input-form">
       @csrf
       ...
       <textarea type="text" id="name" name="name" class="non-conformity-input" value="{{$non['Non_Conformity']}}"></textarea>
       </span>
       <span class="raw-material-input-span">
        <label for="quantity" class="input-raw-label"> Preventive Actions:</label>
       <textarea type="text" id="quantity" name="prevent" class="non-conformity-input" value="{{$non['Preventive_Action']}}"></textarea>
       </span>
       <span class="raw-material-input-span">
       <label for="date" class="input-raw-label" class="raw-input"> Date:</label>
       <input type="date" id="date" name="date" class="raw-input" value="{{$non['date']}}">
       </span>
       <span class="raw-material-input-span">
       <label for="approval" class="input-raw-label" class="raw-input">Approval:</label>
       <input type="text" id="date" name="approval" class="raw-input" value="{{$non['Approval']}}">
       </span>
