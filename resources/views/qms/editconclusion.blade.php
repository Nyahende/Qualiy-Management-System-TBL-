...
<div class="homeheader" style="background:url({{asset('images/waterdrops.jpg')}})">
  ...
  <div class="rawmaterialstab">
   ...
   <form action="{{route('updateconclusion')}}" method="POST" class="raw-material-input-form">
       @csrf
       <input type="hidden" name="id" value="{{$editconclusion['id']}}">
       <span class="raw-material-input-span">
        <label for="date" class="input-raw-label"> Date:</label>
       <input type="date" id="name" name="date" class="raw-input" value="{{$editconclusion['Date']}}">
       </span>
       <span class="raw-material-input-span">
        <label for="quantity" class="input-raw-label"> Agenda:</label>
       <input type="text" id="quantity" name="agenda" class="raw-input" value="{{$editconclusion['Agenda']}}">
       </span>
       <span class="raw-material-input-span">
        <label for="quantity" class="input-raw-label"> Conclusions:</label>
       <textarea type="text" id="quantity" name="conclusion" class="non-conformity-input" value="{{$editconclusion['Conclusions']}}"></textarea>
       </span>
       <span class="raw-material-input-span">
        <label for="approval" class="input-raw-label"> Approval:</label>
       <input type="text" id="quantity" name="approval" class="non-conformity-input" value="{{$editconclusion['Approval']}}">
       </span>
