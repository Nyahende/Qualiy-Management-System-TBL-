...
<body>
    ...
    <div class="thebackground-image"  style="background:url({{asset('images/indexpaint.jpg')}})">
        ...
        <form action="{{route('reset.password.post')}}" class="forgot-password-form" method="post">
            @csrf           
            @if(Session::get('fail'))
                {{Session::get('fail')}}
            @endif
        <div class="theauthform">
        <h1 class="authheading" >Password Reset </h1>
            <input type="text" placeholder="Email" class="authinput" name="email"><br> <br>         
            <input type="password" placeholder="New Password" class="authinput" name="password"><br> <br>         
            <input type="password" placeholder="Confirm New Password" class="authinput" name="password_confirm"><br> <br>         
