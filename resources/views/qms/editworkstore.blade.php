...
<body>
    ...
    <h1 class="chatword">CHATS</h1>
        ...
        <h1 class="loginfor">STORE DEPARTMENT</h1>
   ...
   <h1 class="raw-material-product-name">STORE DEPARTMENT WORKERS</h1>
   <div class="edit-worker-form-div">
   <form action="{{route('updatestoreworker')}}" class="raw-material-input-form" method="POST">
         @csrf
