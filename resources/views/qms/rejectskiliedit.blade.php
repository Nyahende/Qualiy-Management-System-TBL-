...
<body>
  ...
  <div class="rawmaterialstab">
   ...
   <form action="{{route('updaterejectskili')}}" method="POST" class="raw-material-input-form">
       @csrf
       <input type="hidden" name="id" value="{{$updatekilirejects['id']}}">
       <span class="raw-material-input-span">
       <span class="raw-material-input-span">
        <label for="quantity" class="input-raw-label"> Quantity:</label>
       <input type="text" id="quantity" name="quantity" class="raw-input" value="{{$updatekilirejects['Quantity']}}">
       </span>
       <span class="raw-material-input-span">
       <label for="quantity" class="input-raw-label" class="raw-input"> Date:</label>
       <input type="date" id="date" name="date" class="raw-input" value="{{$updatekilirejects['Date']}}">
       </span>
       <span class="raw-material-input-span">
       <label for="approval" class="input-raw-label" class="raw-input" > Approval:</label>
       <input type="text" id="date" name="approval" class="raw-input" value="{{$updatekilirejects['Approval']}}">
       </span>
