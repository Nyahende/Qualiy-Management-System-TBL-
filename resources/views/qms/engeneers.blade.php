...
<div id="engineershome" >
   ...
   <form action="{{route('engineers.addworker')}}" class="raw-material-input-form" method="POST">
         @csrf
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Extra}}</td>
           <td><a href="{{'editengineeworker/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deleteengine/'.$item->id}}">Delete</a></td>
           </tr>
           @endforeach
        </table>
        </div>
   ...
   <form action="{{route('engineers.addengmachines')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Status}}</td>
           <td><a href="{{'editmachineengine/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deleteenginemachine/'.$item->id}}">Delete</a></td>
   ...
   <form action="{{route('engineers.addengsafety')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Size}}</td>
           <td>{{$item->Quantity}}</td>
           <td><a href="{{'editsafetyengine/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deleteenginesafety/'.$item->id}}">Delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
   ...
   <div class="worker-form-div">
   <form action="{{route('eng.addtrain')}}" class="raw-material-input-form" method="POST">
       @csrf
       <span class="raw-material-input-span">
   ...
   <div class="tool-form-div">
   <form action="{{route('eng.addengdefects')}}" method="POST" class="raw-material-input-form">
       @csrf
       <span class="raw-material-input-span">
        <label for="name" class="input-raw-label">Name:</label>
       <input type="text" id="name" name="name" class="raw-input">
       ...
       <table class="competence-workers-table">
           ...
           <td>{{$item->Operator}}</td>
           <td>{{$item->Approve}}</td>
           <td><a href="{{'editdefectsengine/'.$item->id}}"> Edit </a></td>
           <td><a href="{{'deleteenginedefects/'.$item->id}}">Delete</a></td>
           </tr>
           @endforeach
       </table>
       </div>
