...
<body>
  ...
  <div class="rawmaterialstab">
      <ul>
          <li><a href="#kilitablediv">CASTLE LITE</a></li>
      </ul>
   <div id="releasedkilitablediv">
   <h1 class="raw-material-product-name">CASTLE LITE</h1>
   <div class="releasededit-form-div">
   <form action="{{route('updatereleasedclite')}}" method="POST" class="raw-material-input-form">
       @csrf
       <input type="hidden" name="id" value="{{$updateclitereleased['id']}}">
       <span class="raw-material-input-span">
       <span class="raw-material-input-span">
        <label for="quantity" class="input-raw-label"> Quantity:</label>
       <input type="text" id="quantity" name="quantity" class="raw-input" value="{{$updateclitereleased['Quantity']}}">
       </span>
       <span class="raw-material-input-span">
       <label for="quantity" class="input-raw-label" class="raw-input"> Date:</label>
       <input type="date" id="date" name="date" class="raw-input" value="{{$updateclitereleased['Date']}}">
       </span>
       <span class="raw-material-input-span">
       <label for="approval" class="input-raw-label" class="raw-input" > Approval:</label>
       <input type="text" id="date" name="approval" class="raw-input" value="{{$updateclitereleased['Approval']}}">
       </span>
