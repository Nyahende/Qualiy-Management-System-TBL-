...
<body>
    ...
    <div class="thebackground-image"  style="background:url({{asset('images/indexpaint.jpg')}})">
        ...
        <h1 class="forgot-heading" >Forgot you password? No Problem, just provide your email and the password reset link will be sent to you! </h1>
            <input type="text" placeholder="Enter Your Email" class="forgot-input" name="email" :value="old('email')"><br>   
